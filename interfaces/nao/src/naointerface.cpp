...
Memory* naointerface::MEMORY_INSTANCE = NULL;
  ...
  AL::ALModule(broker, name)
{
  ...
  size_t len = body_id.copy(robot_state_->body_id_, 16);
  robot_state_->body_id_[len] = 0;
...
void naointerface::initMemory() {
  // setup the memory
  MEMORY_INSTANCE = memory_ = new Memory(true,MemoryOwner::INTERFACE,0,1,true);
